/* ============================================================================
   ...
   Vanilla JS only. Handles:
     ...
     6. Footer year
     7. Hero background video (reduced-motion pause)
...
(function () {
  ...
  /* ==========================================================================
     ...
     The clip is silent (no audio track) and plays muted on loop. For
     visitors who prefer reduced motion, pause it on the first frame.
     ========================================================================== */
